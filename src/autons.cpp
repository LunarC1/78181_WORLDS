...
void sixball(){
  ...
  back_wings.set(true);
  chassis.diffram(-70,-36,1700,630);
  chassis.set_heading(0);
  // chassis.diff2(36, 70, 1700, 400);
  chassis.diff(60,15,300,200);
  // chassis.drive_distance(9);
